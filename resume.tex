...
%----------------------------------------------------------------------------------------
            ...
            \cvskill{Software development} {9+ yrs.} {1} \\[2pt]
            \cvskill{.NET/C\#} {6+ yrs.} {0.66} \\[2pt]
            \cvskill{Web development} {4+ yrs.} {0.44} \\[2pt]
            \cvskill{Distributed systems} {3+ yrs.} {0.33} \\[2pt]
            \cvskill{Diagnostics} {1+ yrs.} {0.11} \\[2pt]
            \cvskill{Kotlin} {1+ yrs.} {0.11} \\[2pt]
...
%----------------------------------------------------------------------------------------
            ...
            \iconhref{Home}{16}{Blog}{https://northern-dev.net/}{black}\\[2pt]
...
%----------------------------------------------------------------------------------------
            ...
            \cvtext{
                I really fond of ASP.NET Core programming and creating some cool stuff.

                Also, I'm interested in open source development, so I have some public repositories with pet-projects, which give me an opportunity to try new technologies or development methodologies and be open to exchange view about them with other developers. Besides, I have a personal blog in English, where parts of my pet-projects are also used as examples for articles.

                As well, I like to feel myself a part of international developers community and that motivated me to become a .NET Foundation member and join community activities in Saint Petersburg.
            }
